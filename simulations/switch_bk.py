...
class Executor(Simulation.Process):
    ...
    def run(self):
        ...
        if(self.switch.isSpine()):
            ...
            if(not (self.switch.selectionStrategy == "passive") and (not self.task.response) and self.switch.isNeighbor(self.task.src) and (not self.task.isCut)):
            ...
            if(not (self.switch.selectionStrategy == "passive") and self.task.response and self.switch.isNeighbor(self.task.dst) and (not self.task.isCut)):
